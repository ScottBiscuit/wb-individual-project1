...
export default function ModalEditPartyBS({ party, setParty, PC }) {
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Edit Party Member - Backstory</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" >
              <Form.Label>Character Backstory:</Form.Label>
              <Form.Control 
                as="textarea" 
                rows={10} 
