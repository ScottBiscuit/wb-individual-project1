...
export default function ModalEditPartyGM({ party, setParty, PC }) {
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Edit Party Member - Goals/Missions</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" >
              <Form.Label>Character Goals or Missions:</Form.Label>
              <Form.Control 
                as="textarea" 
                rows={10} 
                placeholder="Enter goals or missions..." 
                name="pcGoals" 
                onChange={handleChange} 
                value={formState.pcGoals}
                autoFocus 
              />
            </Form.Group>
