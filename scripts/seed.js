import { User, Character, SessionNote, Campaign, db, DMNote } from '../src/model.js';
...
const dmNotesToCreate = [
    ...
    {dmNoteIdeas: 'Rumours are spreading in town of howls in the forest and children are missing'},
...
dmNotesToCreate.forEach((dmnote) => DMNote.create(dmnote))
